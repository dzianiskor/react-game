                        ...
                        {getArenaList().map((arena) =>
                            (props.typeArena.id === arena.id)
                                ...
                                : <button
                                    key={arena.id}
                                    onClick={() => {
                                        props.changeArena(arena)
                                        setSavedData('arena', arena)
                                    }}
                                >{arena.name}</button>
                        )}
                    </div>
                        ...
                        {getWrapperCardList().map((wrapper) =>
                            (props.typeWrapperCard.id === wrapper.id)
                                ...
                                : <button
                                    key={wrapper.id}
                                    onClick={() => {
                                        props.changeWrapperCard(wrapper)
                                        setSavedData('wrapperCard', wrapper)
                                    }}
                                >{wrapper.name}</button>
                        )}
                    </div>
                        ...
                        {getDifficultList().map((difficult, index) =>
                            (props.difficult === difficult.value)
                                ...
                                : <button
                                    key={index}
                                    onClick={() => {
                                        props.changeDifficult(difficult.value)
                                        setSavedData('difficult', difficult.value)
                                    }}
                                >{difficult.name}</button>
                        )}
                    </div>
                </div>
                <div className="setting-card">
